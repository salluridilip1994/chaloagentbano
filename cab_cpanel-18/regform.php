...
<!------------------------------------->
 ...
 <?php include_once('include/social.php')?>
	...
	<div class="row mb-5">
		<div class="col-md-8 " style="border-right: solid pink 3px;">

<div class="col-md-12">
	<h5 class="text-center"><?php  $result; ?></h5>
		<form action="contactemail.php" method="post">
			<h3><b><u>LIC Registrartion Form</u></b></h3>
						<div class="row">
							<div class="col-md-12 mt-1">
				<!-- <label>Name:</label> -->
				<input type="text" name="name" class="form-control" pattern="[a-zA-Z]{1,}" required placeholder="Enter Your Name">
			</div>
			<div class="col-md-12  mt-3">
				<!-- <label>Number:</label> -->
				<input type="text" name="phone" class="form-control" pattern="[1-9]{1}[0-9]{9}" required placeholder="Enter Mobile Number">
				...
				<div class="row">
							<div class="col-md-12 mt-3">
			<!-- 	<label>Email:</label> -->
				<input type="text mt-1" name="email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required placeholder=" Enter Email">
			</div>
			<div class="col-md-12 mt-3">
				<!-- <label>Subject:</label> -->
		...
		<div class="row m-0 mt-3">
			<textarea class="form-control" rows="2" placeholder="Message" name="mesage" required></textarea>
		</div>
