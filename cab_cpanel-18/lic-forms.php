        ...
        body p
{
  text-align: justify;
    ...
    <body>
        ...
        <?php inlude_once('header.php')?>
        <section class="mt-5 bj" >
            <div class="container mt-5">

                 <h1 class="text-center font-weight-bold m-5 mt-5" style="background-color:#005476; color: white;">Download Forms </h1>
                <div class="row">
