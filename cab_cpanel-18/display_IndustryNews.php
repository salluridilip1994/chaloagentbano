...
<body>
  ...
  <div class="container">
    ...
    <div class="info">
     ...
     <p class="CtntParaimg"><img src="<?php echo "webmaster/".$inews_row['File_Path']; ?>" alt="" width="1095px" height="500px"></p>
   ...
   <div class="btmblue">
     <div class="row">
      ...
      <div class="col-md-4"><a href="industry-news.php" style="color:white;margin-left: 40%"><i class="fa fa-caret-left" aria-hidden="true"></i><b> back</b></a></div>
    </div>
  </div>
</div>
</div>
